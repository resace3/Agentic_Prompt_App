...
def analysis_visuals_context(analysis_visuals):
    ...
    return (
        ...
        "alignment. Do not ask whether the user wants plots, DAGs, or equations; they are "
        "already rendered below the message. Keep the text description consistent with "
        "these rendered artifacts:\n"
